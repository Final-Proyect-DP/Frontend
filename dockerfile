...
ARG VITE_API_GET_USER_ITEMS
ARG VITE_API_UPDATE_PRODUCT
ARG VITE_API_DELETE_PRODUCT
...
ENV \
  ...
  VITE_API_GET_USER_ITEMS=${VITE_API_GET_USER_ITEMS} \
  VITE_API_UPDATE_PRODUCT=${VITE_API_UPDATE_PRODUCT} \
  VITE_API_DELETE_PRODUCT=${VITE_API_DELETE_PRODUCT}
